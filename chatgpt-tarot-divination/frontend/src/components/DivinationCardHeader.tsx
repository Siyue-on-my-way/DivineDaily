...
export function DivinationCardHeader({
  ...
  return (
    <div className="space-y-4 md:space-y-6 animate-in fade-in duration-500">
      <Card className="backdrop-blur-lg bg-card/50 shadow-xl border-primary/10 hover:border-primary/20 transition-all relative w-full min-h-[600px] md:min-h-[650px] lg:min-h-[700px] flex flex-col">
        {/* 返回按钮 */}
        <Button
          onClick={handleBack}
          variant="ghost"
        ...
        {/* 标题区域 */}
        <CardHeader className="p-4 md:p-6 pb-3 md:pb-4 text-center flex-shrink-0">
        ...
        {/* 内容区域 */}
        <CardContent className="pt-0 px-4 md:px-6 pb-4 md:pb-6 flex-1 flex items-center justify-center">
