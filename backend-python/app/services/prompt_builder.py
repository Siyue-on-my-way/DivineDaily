...
"""
        ...
        if analysis:
            ...
            base_prompt += """
【重要】请使用 Markdown 格式回答（100-150字），结构如下：
...
"""
        ...
        prompt += """
请使用 Markdown 格式撰写详细的解卦报告（300-500字）：
...
"""
    ...
    def _guidance_relationship(analysis: QuestionAnalysis) -> str:
        """感情类问题指导"""
        guidance = """
【这是一个感情问题】请使用 Markdown 格式回答（100-150字）：
...
"""
    ...
    def _guidance_career(analysis: QuestionAnalysis) -> str:
        """事业类问题指导"""
        guidance = """
【这是一个事业问题】请使用 Markdown 格式回答（100-150字）：
...
"""
    ...
    def _guidance_decision(analysis: QuestionAnalysis) -> str:
        """决策类问题指导"""
        guidance = """
【这是一个决策问题】请使用 Markdown 格式回答（100-150字）：
...
**注意**：这是一个复杂问题，涉及多个维度。请在回答中综合考虑这些因素，给出平衡的建议。
"""
